      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden items-center gap-4 sm:flex">
            <Link href={`/${locale}/`} className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)]">
              首页
            </Link>
            <Link href={`/${locale}/learn/s01`} className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)]">
              课程
            </Link>
          </nav>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={toggleDark}
            className="rounded-lg p-2 text-[var(--color-text-secondary)] hover:bg-zinc-100 dark:hover:bg-zinc-800"
